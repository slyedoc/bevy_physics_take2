...
use bevy_physics_take2::{PhysicsConfig, CollisionDetection};
...
fn toggle_physics(
    ...
    if input.just_pressed(KeyCode::F1) {
        config.detection = match config.detection {
            CollisionDetection::Static =>  CollisionDetection::Dynamic,
            CollisionDetection::Dynamic => CollisionDetection::Static,
        };
    }
